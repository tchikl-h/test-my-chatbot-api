...
const chatbotProperties = ["id", "project_name", "description", "dialogflow_project_id", "dialogflow_client_email", "dialogflow_private_key", "companyId", "created_at", "date_update", "deleted_at"];
